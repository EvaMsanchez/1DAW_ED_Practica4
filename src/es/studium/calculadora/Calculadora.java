...
public class Calculadora implements WindowListener, ActionListener 
{
	...
	public Calculadora()
	{
		...
		ventana.add(pantalla, BorderLayout.NORTH); //Se añade el textfield en el norte.
		
		panel.setLayout(new GridLayout(4, 3)); //Al panel para poner los botones. Filas y columnas.
		//Listeners y botones al panel.
		...
		ventana.add(panel, BorderLayout.CENTER); //Se añade el panel(con los botones) en el centro.
	...
	public void actionPerformed(ActionEvent e)
	{
				...
				|| botonPulsado.equals("/"))
		{
			...
			operador1 = Integer.parseInt(pantalla.getText()); //Se guarda el número que se ha introducido antes de pulsar el dicho operador.
			nuevoNumeroEnPantalla = true;
		}
		
		else //Sino se ha pulsado ningún operador, comprueba si hay un número en la pantalla.
		{
			if (nuevoNumeroEnPantalla == true) //Si hay un número en la pantalla quiere decir que ha pulsado un operador.
			{
				pantalla.setText(botonPulsado); //Mostrar en pantalla el número que el usuario acaba de pulsar.
